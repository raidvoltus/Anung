...
if __name__ == "__main__":
    ...
    if results:
        ...
        message = "<b>🍆Kontil News update: Dukun pasar saham kita kesurupan lagi! Berikut bisikan gaib buat para kontil yang masih percaya hidup itu keras, tapi para kontil bisa lebih keras, calm your shit and here is the list💩:</b>\n"
        for r in top_5:
            message += (
                f"\n🔹 {r['ticker']}\n   💰 Harga: {r['harga']:.2f}\n   "
...
Perbaiki logika tp/sl 
2025-04-12 17:52:45,512 - WARNING - Sinyal tidak valid untuk ABMM.JK - TP: 5088.381439330928, SL: 6771.129425858766, Harga: 2960.0

2025-04-12 17:52:45,515 - WARNING - Sinyal tidak valid untuk ACST.JK - TP: 5090.283975283145, SL: 7969.828992621218, Harga: 69.0

2025-04-12 17:52:45,527 - WARNING - Sinyal tidak valid untuk ABBA.JK - TP: 5092.093267182821, SL: 8480.162550170775, Harga: 16.0
