...
if __name__ == "__main__":
    ...
    if results:
        ...
        message = "<b>🍆Kontil news: Dukun pasar saham kita kesurupan lagi! Berikut bisikan gaib buat para kontil yang masih percaya hidup itu keras, tapi market bisa lebih keras 📊 :</b>\n"
        for r in top_5:
            message += (
                f"\n🔹 {r['ticker']}\n   💰 Harga: {r['harga']:.2f}\n   "
