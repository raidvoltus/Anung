...
model_close_path = "model_close.txt"
...
def analyze_stock(ticker):
    try:
        ...
        X_train_high, _, y_train_high, _ = train_test_split(X, y_high, test_size=0.2)
        X_train_low, _, y_train_low, _ = train_test_split(X, y_low, test_size=0.2)
        X_train_close, _, y_train_close, _ = train_test_split(X, y_close, test_size=0.2)
